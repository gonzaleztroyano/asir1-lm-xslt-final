...
<xsl:template match="inmuebles">
	<html>
		...
		<body>
			<div> <p style="color: grey; text-align: center">NOTA: Para ver el documento XSLT que ha generado esta página cambie la extensión desde ".html" a ".xslt" en la barra de su navegador o haz clic <a style="color: grey;" href="./zz_inmuebles_alquiler.xslt">aquí</a>.<br/>Puedes acceder a los datos de origen desde <a  style="color: grey;" href="./PrácticaGlobal-XML-2PabloGonzález-LM-1ASIR.xml">este enlace</a>.</p></div>
			<hr/>
			<div id="header">
			...
			<br/>
				<h1 style="margin: 1%;">Inmuebles en régimen de alquiler</h1>
